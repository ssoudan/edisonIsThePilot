...
IMPL_LIST := conf control alarm dashboard pilot gps steering stepper drivers/pwm drivers/mcp4725 drivers/gpio drivers/motor  infrastructure/logger infrastructure/pid  #<-- Implementation directories
